...
public class QueryLogger(ILogger<QueryLogger> logger) : ExecutionDiagnosticEventListener
{
    ...
    private class RequestScope : IDisposable
    {
        ...
        public RequestScope(ILogger<QueryLogger> logger, IRequestContext context)
        {
            _logger = logger;
            _context = context;
