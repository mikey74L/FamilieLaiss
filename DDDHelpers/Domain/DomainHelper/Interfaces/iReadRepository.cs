...
public interface iReadRepository<TEntity> where TEntity : EntityBase
{
    ...
    Task<List<TEntity>> GetAll(Expression<Func<TEntity, bool>> predicateWhere = null, string includeNav = null, int? Take = null, int? Skip = null);
    ...
    Task<long> GetCount(Expression<Func<TEntity, bool>> predicate = null);
