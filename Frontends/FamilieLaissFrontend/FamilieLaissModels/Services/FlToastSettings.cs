...
namespace FamilieLaissModels.Components;

public class FlToastSettings : IFlToastSettings
{
    /// <summary>
    ...
    /// </summary>
    public FLToastIconType? IconType { get; set; }
    ...
    /// </summary>
    public FLToastPosition? Position { get; set; }

    public string PositionClass => $"position-{Position?.ToString().ToLower()}";

    public FlToastSettings(
        string additionalClasses,
        FLToastIconType? iconType,
        string icon,
        ...
        FLToastPosition? toastPosition)
    {
        ...
        {
            AdditionalClasses += " fl-toast-action";
        }
    }
