...
public static class FlApplicationViewModelExtension
{
    public static IServiceCollection AddViewModels(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection
            .AddTransient<FilterAppBarControlViewModel<IUploadPictureModel, UploadPictureSortInput,
                UploadPictureFilterInput>>();
        serviceCollection
            .AddTransient<
                FilterAppBarControlViewModel<IUploadVideoModel, UploadVideoSortInput, UploadVideoFilterInput>>();
        ...
        serviceCollection.AddTransient<VideoControlInfoViewModel>();
        ...
        serviceCollection.AddTransient<ChooseVideoDialogViewModel>();
