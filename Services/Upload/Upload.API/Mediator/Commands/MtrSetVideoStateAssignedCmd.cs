...
{
    /// <summary>
    /// Mediatr Command for set status for video to assigned
    /// </summary>
    public class MtrSetVideoStateAssignedCmd : IRequest
    {
    ...
    /// <summary>
    /// Mediatr Command-Handler for set status for video to assigned
    /// </summary>
    public class MtrSetVideoStateAssignedCmdHandler(iUnitOfWork unitOfWork, ILogger<MtrSetVideoStateAssignedCmdHandler> logger) : IRequestHandler<MtrSetVideoStateAssignedCmd>
    {
        ...
        public async Task Handle(MtrSetVideoStateAssignedCmd request, CancellationToken cancellationToken)
        {
            ...
            itemToChange.SetVideoStateToAssigned();
