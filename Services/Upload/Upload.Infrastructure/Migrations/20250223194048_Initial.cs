        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDateUploadBlob = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FinishDateUploadBlob = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    StartDateDeleteFiles = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FinishDateDeleteFiles = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UploadPictureId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
