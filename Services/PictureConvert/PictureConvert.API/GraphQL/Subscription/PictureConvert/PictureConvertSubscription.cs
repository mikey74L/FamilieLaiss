...
using PictureConvert.API.Enums;
using PictureConvert.Domain.Entities;
using PictureConvert.Infrastructure.DBContext;
using System.Runtime.CompilerServices;

namespace PictureConvert.API.GraphQL.Subscription.PictureConvert;
...
public class PictureConvertSubscription
{
    public async IAsyncEnumerable<PictureConvertStatus> OnPictureConvertStatusWaitingStream(
        [Service] IDbContextFactory<PictureConvertServiceDbContext> dbContextFactory,
