namespace PictureConvert.API.Models;
...
public class AppSettings
{
    ...
    /// </summary>
    public string EndpointPictureConverterService { get; set; } = string.Empty;

    /// <summary>
    /// Endpoint for Picture-Convert-Execute-Service
    /// </summary>
    public string EndpointPictureConverterServiceExecute { get; set; } = string.Empty;
