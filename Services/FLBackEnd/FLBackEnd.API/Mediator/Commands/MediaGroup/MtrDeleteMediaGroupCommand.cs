...
/// </summary>
public class MtrDeleteMediaGroupCommand : IRequest<Domain.Entities.MediaGroup>
{
    #region Properties
    /// <summary>
...
/// </summary>
public class MtrDeleteMediaGroupCommandHandler(iUnitOfWork unitOfWork, ILogger<MtrDeleteMediaGroupCommandHandler> logger) : IRequestHandler<MtrDeleteMediaGroupCommand, Domain.Entities.MediaGroup>
{
    ...
    public async Task<Domain.Entities.MediaGroup> Handle(MtrDeleteMediaGroupCommand request, CancellationToken cancellationToken)
    {
        logger.LogInformation("Mediatr-Handler for delete media group command was called for {@Input}", request.InputData);
