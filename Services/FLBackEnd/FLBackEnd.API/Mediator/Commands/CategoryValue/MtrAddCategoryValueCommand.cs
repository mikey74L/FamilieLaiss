...
/// </summary>
public class MtrAddCategoryValueCommand : IRequest<Domain.Entities.CategoryValue>
{
    /// <summary>
...
public class MtrAddCategoryValueCommandHandler(
    ...
    : IRequestHandler<MtrAddCategoryValueCommand, Domain.Entities.CategoryValue>
{
    /// <summary>
    ...
    public async Task<Domain.Entities.CategoryValue> Handle(MtrAddCategoryValueCommand request,
