...
namespace FLBackEnd.Infrastructure.Migrations
{
    ...
    [Migration("20240403091352_AddedPropertiesToUserSetting")]
    partial class AddedPropertiesToUserSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FLBackEnd.Domain.Entities.UserSetting", b =>
                {
                    ...
                    b.Property<int>("VideoTimeSeekBackward")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(10);

                    b.Property<int>("VideoTimeSeekForward")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30);
