...
public class UploadPicture : EntityCreation<long>
{
    ...
    public PictureConvertStatus ConvertStatus { get; private set; }
    ...
    {
        await _lazyLoader.LoadAsync(this, navigationName: nameof(ConvertStatus));

        await ConvertStatus.EntityDeletedAsync(dbContext, dictContextParams);
    }
