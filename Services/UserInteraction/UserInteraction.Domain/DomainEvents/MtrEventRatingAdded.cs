...
{
    /// <summary>
    /// Event for rating added
    /// </summary>
    public class MtrEventRatingAdded : DomainEventMultiple
    {
        #region Properties
        /// <summary>
        ...
        public MtrEventRatingAdded(long id, long userInteractionInfoID, string userAccountID) : base(id.ToString())
        {
