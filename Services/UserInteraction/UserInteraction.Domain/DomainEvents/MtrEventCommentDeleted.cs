...
{
    /// <summary>
    /// Event for comment deleted
    /// </summary>
    public class MtrEventCommentDeleted : DomainEventMultiple
    {
        #region Properties
        /// <summary>
        ...
        public MtrEventCommentDeleted(long id, long userInteractionInfoID, string userAccountID) : base(id.ToString())
        {
