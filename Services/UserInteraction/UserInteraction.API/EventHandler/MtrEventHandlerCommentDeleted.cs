...
{
    /// <summary>
    /// Event handler for comment deleted
    /// </summary>
    public class MtrEventHandlerCommentDeleted : INotificationHandler<MtrEventCommentDeleted>
    {
        #region Private Members
        private readonly iUnitOfWork _UnitOfWork;
        private readonly ILogger<MtrEventHandlerCommentDeleted> _Logger;
        #endregion
        ...
        public MtrEventHandlerCommentDeleted(iUnitOfWork unitOfWork, ILogger<MtrEventHandlerCommentDeleted> logger)
        {
        ...
        public async Task Handle(MtrEventCommentDeleted notification, CancellationToken cancellationToken)
        {
            //Logging ausgeben
            _Logger.LogInformation("Mediatr-Handler for comment deleted was called with following parameters:");
