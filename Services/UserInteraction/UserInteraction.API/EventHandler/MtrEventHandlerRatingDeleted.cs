...
{
    /// <summary>
    /// Event handler for rating deleted
    /// </summary>
    public class MtrEventHandlerRatingDeleted : INotificationHandler<MtrEventRatingDeleted>
    {
        #region Private Members
        private readonly iUnitOfWork _UnitOfWork;
        private readonly ILogger<MtrEventHandlerRatingDeleted> _Logger;
        #endregion
        ...
        public MtrEventHandlerRatingDeleted(iUnitOfWork unitOfWork, ILogger<MtrEventHandlerRatingDeleted> logger)
        {
        ...
        public async Task Handle(MtrEventRatingDeleted notification, CancellationToken cancellationToken)
        {
            //Logging ausgeben
            _Logger.LogInformation("Mediatr-Handler for rating deleted was called with following parameters:");
            ...
            if (InfoEntity != null)
            {
                ...
                await InfoEntity.UpdateRatingInfo();
            }
            ...
            if (AccountEntity != null)
            {
                ...
                await AccountEntity.UpdateRatingInfo();
            }
