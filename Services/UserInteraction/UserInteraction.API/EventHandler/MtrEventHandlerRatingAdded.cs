...
{
    /// <summary>
    /// Event handler for rating added
    /// </summary>
    public class MtrEventHandlerRatingAdded : INotificationHandler<MtrEventRatingAdded>
    {
        #region Private Members
        private readonly iUnitOfWork _UnitOfWork;
        private readonly ILogger<MtrEventHandlerRatingAdded> _Logger;
        #endregion
        ...
        public MtrEventHandlerRatingAdded(iUnitOfWork unitOfWork, ILogger<MtrEventHandlerRatingAdded> logger)
        {
        ...
        public async Task Handle(MtrEventRatingAdded notification, CancellationToken cancellationToken)
        {
            //Logging ausgeben
            _Logger.LogInformation("Mediatr-Handler for rating added was called with following parameters:");
