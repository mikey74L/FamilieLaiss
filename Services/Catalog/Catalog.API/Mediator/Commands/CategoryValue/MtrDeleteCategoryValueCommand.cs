...
/// </summary>
public class MtrDeleteCategoryValueCommand : IRequest<Domain.Aggregates.CategoryValue>
{
    /// <summary>
...
public class MtrDeleteCategoryValueCommandHandler(
    ...
    : IRequestHandler<MtrDeleteCategoryValueCommand, Domain.Aggregates.CategoryValue>
{
    ...
    public async Task<Domain.Aggregates.CategoryValue> Handle(MtrDeleteCategoryValueCommand request,
