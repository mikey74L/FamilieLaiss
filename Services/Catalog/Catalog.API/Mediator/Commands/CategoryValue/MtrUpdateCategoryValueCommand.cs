...
/// </summary>
public class MtrUpdateCategoryValueCommand : IRequest<Domain.Aggregates.CategoryValue>
{
    /// <summary>
    /// GraphQL input data
    /// </summary>
...
public class MtrUpdateCategoryValueCmdHandler(iUnitOfWork unitOfWork, ILogger<MtrUpdateCategoryValueCmdHandler> logger)
    : IRequestHandler<MtrUpdateCategoryValueCommand, Domain.Aggregates.CategoryValue>
{
    /// <summary>
    ...
    public async Task<Domain.Aggregates.CategoryValue> Handle(MtrUpdateCategoryValueCommand request,
