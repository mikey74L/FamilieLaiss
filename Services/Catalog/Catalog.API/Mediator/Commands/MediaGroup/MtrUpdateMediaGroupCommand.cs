...
/// </summary>
public class MtrUpdateMediaGroupCommand : IRequest<Domain.Aggregates.MediaGroup>
{
    #region Properties
...
/// </summary>
public class MtrUpdateMediaGroupCommandHandler(
    iUnitOfWork unitOfWork,
    ILogger<MtrUpdateMediaGroupCommandHandler> logger)
    : IRequestHandler<MtrUpdateMediaGroupCommand, Domain.Aggregates.MediaGroup>
{
    ...
    public async Task<Domain.Aggregates.MediaGroup> Handle(MtrUpdateMediaGroupCommand request,
        CancellationToken cancellationToken)
    {
        logger.LogInformation("Mediatr-Handler for update media group command was called for {@Input}",
            request.InputData);
