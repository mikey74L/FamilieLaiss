...
/// </summary>
public class MtrDeleteCategoryCmd : IRequest<Domain.Aggregates.Category>
{
    /// <summary>
...
public class MtrDeleteCategoryCmdHandler(iUnitOfWork unitOfWork, ILogger<MtrDeleteCategoryCmdHandler> logger)
    : IRequestHandler<MtrDeleteCategoryCmd, Domain.Aggregates.Category>
{
    /// <summary>
    ...
    public async Task<Domain.Aggregates.Category> Handle(MtrDeleteCategoryCmd request,
