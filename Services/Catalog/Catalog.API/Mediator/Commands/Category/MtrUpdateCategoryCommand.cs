...
/// </summary>
public class MtrUpdateCategoryCmd : IRequest<Domain.Aggregates.Category>
{
    /// <summary>
    /// GraphQL input data
    /// </summary>
...
public class MtrUpdateCategoryCmdHandler(iUnitOfWork unitOfWork, ILogger<MtrUpdateCategoryCmdHandler> logger)
    : IRequestHandler<MtrUpdateCategoryCmd, Domain.Aggregates.Category>
{
    /// <summary>
    ...
    public async Task<Domain.Aggregates.Category> Handle(MtrUpdateCategoryCmd request,
