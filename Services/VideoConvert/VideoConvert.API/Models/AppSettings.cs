namespace VideoConvert.API.Models;
...
public class AppSettings
{
    ...
    /// </summary>
    public string EndpointVideoConverterService { get; set; } = string.Empty;

    /// <summary>
    /// Endpoint for Video-Convert-Execute-Service
    /// </summary>
    public string EndpointVideoConverterServiceExecute { get; set; } = string.Empty;
